...
%
%function u=sunmeladat(selection);
% input: selection is four element row vector with 0 or 1
%                    [year male_melanoma total_melanoma sunspot_number]
% output: u - matrix with Andrews and Herzberg data columns
%
%examples: sunmeladat([1 1 1 1]) | sunmeladat() return all series
...
%          sunmeladat(1) | sunmeladat([1]) yield year column
%          
% Data File skin.dat is from Andrews and Herzberg.
