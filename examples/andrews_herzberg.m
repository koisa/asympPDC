...
metric = 'info';
alpha = 0.01;
e = asymp_pdc(u,A,pf,nFreqs,metric,alpha); % Estimate iPDC and asymptotic statistics
...
[hxlabel hylabel] = xplot(e,flgPrinting,fs,w_max,chLabels, ...
                     flgColor,flgScale,flgMax,flgSignifColor);
   xplot_title(alpha,metric,'pdc');
...
set(h1,'NumberTitle','off','MenuBar','none', ...
   'Name','Andrews & Herzberg''s Sunspot-Melanoma Series (1936-1972)')
[hxlabel hylabel] = pvalues_xplot(c, flgPrinting,fs,w_max,chLabels, ...
                     flgColor);

xplot_title(alpha,metric,'p-value iPDC');
