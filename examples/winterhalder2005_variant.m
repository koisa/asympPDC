%% WINTERHALDER ET AL. (2005) 7-DIMENSIONAL UNBALANCED RANDOM INDEPENDENT VARIABLES
% Description:
%
...
%              | | | | | | 7 Spectra (0: w/o SS;    1: Linear; 
%              | | | | | |            2: Log-scale; 3: Auto|PDC/DTF|^2)
%              | | | | | 6 Coherence plot in gray line
%              | | | | 5 (Obsolete)
%              | | | 4 Plot confidence limits
%              | | 3 Significant PDC/DTF in red line
%              | 2 Patnaik threshold level in black dashed-line
%              1 PDC/DTF in green (or other color) line
...
strTitle = ['DTF (' '{\alpha = ' int2str(100*alpha) '%}' ')'];
switch metric
   case 'euc'
      %nop
   case 'diag'
