...
%FBACCALA2001A_EX3 Linear five-dimensional VAR[3] with feedback model
% from Baccala & Sameshima. Biol.Cybern.84:463-74, 2001. Example 3 (pag.468)')
% with following interactions x1-->x2  x1-->x3 x1-->x4 x4-->x5 x5-->x4');
